...
def uploadserver(serverid):
    ...
    if serverid == '1':
        print('开发服上传中...')
        uploadfiles('http://192.xxx.xxx.xxx/data/%s/filelist.json' % cdndir, 'http://192.xxx.xxx.xxx/data1', 'username', 'password')

    elif serverid == '2':
        print('体验服上传中...')
        uploadfiles('http://192.xxx.xxx.xxx/data/%s/filelist.json' % cdndir, 'http://192.xxx.xxx.xxx/data2', 'username', 'password')

    elif serverid == '3':
        print('测试服上传中...')
        uploadfiles('http://192.xxx.xxx.xxx/data/%s/filelist.json' % cdndir, 'http://192.xxx.xxx.xxx/data', 'username', 'password')
